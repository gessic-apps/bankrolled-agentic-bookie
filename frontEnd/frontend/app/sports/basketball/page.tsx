...
function BasketballMarketsDisplay() {
      ...
      try {
        const marketsDataPromises = (marketAddresses as Address[]).map(async (marketAddress): Promise<Market | null> => {
          try {
            ...
            // Check if this is a basketball game (no draw odds)
            if (oddsData?._drawOdds && Number(oddsData._drawOdds) > 0) {
              return null; // Skip soccer games
            }
  ...
  return (
    <>
      <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Basketball Markets</h2>
      {loading ? (
              ...
              <div className="content-area">
                <header className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow">
                  <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Basketball Betting</h1>
