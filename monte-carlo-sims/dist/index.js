...
commander_1.program
    ...
    const market = (0, utils_1.createSampleMarket)();
    ...
    // Run the simulation
    const simulator = new simulator_1.RiskSimulator(market, config);
    const result = simulator.runSimulation();
    // Print results
    (0, utils_1.printSimulationResults)(market, config, result);
});
    ...
    try {
        ...
        const market = {
            ...
            impliedProbabilities: {
                home: (0, utils_1.decimalToImpliedProbability)(options.homeOdds),
                away: (0, utils_1.decimalToImpliedProbability)(options.awayOdds),
                draw: options.drawOdds ? (0, utils_1.decimalToImpliedProbability)(options.drawOdds) : undefined
            },
        ...
        try {
            ...
            if (Object.keys(market.impliedProbabilities).length === 0) {
                for (const outcome in market.currentOdds) {
                    market.impliedProbabilities[outcome] = (0, utils_1.decimalToImpliedProbability)(market.currentOdds[outcome]);
                }
            }
            ...
            const defaultConfig = (0, utils_1.createDefaultConfig)();
            const config = {
                ...defaultConfig,
                ...data.config
            };
